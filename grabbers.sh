...
php /var/www/html/w/grabbers/grabbers/grabLogs.php --db="$dbName" --dbpass="$dbPass" --dbuser="$dbUser" --url="$URL"  --namespaces="$namespaces"
php /var/www/html/w/grabbers/grabbers/grabText.php --db="$dbName" --dbpass="$dbPass" --dbuser="$dbUser"  --url="$URL"  --namespaces="$namespaces"
php /var/www/html/w/grabbers/grabbers/grabFiles.php --db="$dbName" --dbpass="$dbPass" --dbuser="$dbUser" --url="$URL" 
php /var/www/html/w/grabbers/grabbers/grabProtectedTitles.php --db="$dbName" --dbpass="$dbPass" --dbuser="$dbUser" ---url="$URL" 
php /var/www/html/w/grabbers/grabbers/grabUserBlocks.php --db="$dbName" --dbpass="$dbPass" --dbuser="$dbUser" --url="$URL" 
php /var/www/html/w/grabbers/grabbers/grabUserGroups.php --db="$dbName" --dbpass="$dbPass" --dbuser="$dbUser" --url="$URL" 
...
php /var/www/html/w/grabbers/grabbers/grabDeletedText.php --dbpass="$dbPass"  --dbuser="$dbUser" --url="$URL" --namespaces="$namespaces" --username="$username" --password="$botpassword"
php /var/www/html/w/grabbers/grabbers/grabDeletedFiles.php --db="$dbName" --dbpass="$dbPass"  --dbuser="$dbUser" --url="$URL" --username="$username" --password="$botpassword"
